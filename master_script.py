...
freqs = np.arange(start=3.7,stop=4,step=250e-6) # frequencies are in GHz
...
wfms,data,v_b,calib_states,nSteps = qb.coherence_stabilization(qb=qb_name,device_name=device_name,verbose=1,save_data=False)
