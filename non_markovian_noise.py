...
awg.setInt('/dev8233/sigouts/2/on', 1)
awg.setInt('/dev8233/sigouts/3/on', 1)
...
options_spec = {
    'frequencies':      np.arange(start=3,stop=3.7,step=500e-6), # frequencies are in GHz
    'nAverages':        2048,
    'setup':            True,
